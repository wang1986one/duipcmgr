...
//////////////////////////////////////////////////////////////////////////
// CWinPath
CWinPath::CWinPath() throw()
{
}

CWinPath::CWinPath(const CWinPath& path):
m_strPath(path.m_strPath)
{
}

CWinPath::CWinPath(LPCWSTR pszPath):
m_strPath(pszPath )
{
}

CWinPath::operator LPCWSTR() const throw()
{
	return m_strPath;
}

CWinPath& CWinPath::operator+=(LPCWSTR pszMore)
{
	Append( pszMore );
...
CWinPathAttr::CWinPathAttr( const CString& strFilePath )
{
	m_strFilePath = strFilePath;
}

CWinPathAttr::CWinPathAttr( LPCTSTR lpFilePath )
{
	m_strFilePath = lpFilePath;
	_Init();
}

CWinPathAttr::CWinPathAttr()
{
